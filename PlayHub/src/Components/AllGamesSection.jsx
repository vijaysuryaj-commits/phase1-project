...
class AllGamesSection extends Component {
  ...
  componentDidMount() {
    // const { fetchGames, selectedGenre, platform, sortBy } = this.props;
    // fetchGames({ selectedGenre, platform, sortBy });
  }

  componentDidUpdate(prevProps) {
    const { selectedGenre, platform, sortBy, fetchGames } = this.props;
  ...
  render() {
    const { games, loading, error, navigate } = this.props;
    const { totalPages, currentPage } = this.setState
