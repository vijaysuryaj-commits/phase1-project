...
import { setSearchQuery, clearSearchQuery } from "../redux/games/gameActions";
...
class NavBar extends Component {
  ...
  handleResize = () => {
    const isDeskTop = window.innerWidth >= 900;
    this.setState({ showSearchBar: isDeskTop });
  };
  ...
  render() {
    const { anchorEl } = this.state;
    const { auth, selectedGenre, searchQuery } = this.props;
      ...
      <>
        ...
        >
          ...
          >
                  ...
                  <TextField
                    ...
                    InputProps={{
                      endAdornment: (
                        <InputAdornment position="end">
                          {window.innerWidth < 900 ? (
                            <IconButton onClick={this.handleSearchClose}>
                              <Suspense fallback={null}>
                                <CloseIcon sx={{ color: "orange" }} />
                              </Suspense>
                            </IconButton>
                    ...
                    sx={{
                      ...
                      "& .MuiOutlinedInput-root": {
                        ...
                        "&.Mui-focused fieldset": { borderColor: "orange", boxShadow: "0 0 10px orange" },
                      },
                    }}
                  />
                </Slide>
            ...
            <Box
              sx={{
                display: { xs: this.state.showSearchBar ? "none" : "flex", md: "flex" },
              }}
              flexDirection="row"
              alignItems="center"
            >
              ...
              >
                <Suspense fallback={null}>
                  <FavoriteBorderIcon sx={{ color: "orange", textShadow: "0 0 10px orange" }} />
                </Suspense>
                <Typography
                  variant="h6"
                  sx={{
...
export default withRouter(withAuth(connect(mapStateToProps, mapDispatchToProps)(NavBar)));
